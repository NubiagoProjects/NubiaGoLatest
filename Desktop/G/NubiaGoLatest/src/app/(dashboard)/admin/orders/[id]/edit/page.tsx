...
import { ArrowLeft, Save, X, Package, Truck, CheckCircle, Clock, XCircle } from 'lucide-react'
...
export default function EditAdminOrder({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    ...
    const loadOrder = async () => {
      ...
      const mockOrder: Order = {
        ...
        adminNotes: 'Priority order - handle with care'
      }
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
              {(['pending', 'confirmed', 'processing', 'shipped', 'delivered', 'cancelled'] as const).map((statusOption) => (
                <label key={statusOption} className="cursor-pointer">
                  ...
                  <div className={`p-3 rounded-lg border-2 transition-all ${
                    ...
                    <div className="flex flex-col items-center space-y-2">
                      ...
                      <span className="text-xs font-medium capitalize text-center">{statusOption}</span>
                    </div>
                  </div>
                </label>
              ))}
